...
const Users = () => {
	...
	const { data: usersCount } = useGetUsersTotal(token as string);
	const [paginatedData, setPaginatedData] = useState<GridRowsProp>(
			...
			<div className={styles.container__item}>
				<div className={styles.container__item__left}>
					...
					<div>
						...
						<p className={styles.amount}>{usersCount?.totalUsers || 0}</p>
					</div>
				</div>
			</div>
