		...
		<div className={styles.container}>
			<div className={styles.container_top}>
				...
				<div className={styles.details_container}>
					<p className={styles.details}>Transaction is currently ongoing</p>
				</div>
				<div className={styles.details_container}>
					<p className={styles.details}>
						You’ll be requested to confirm this transaction as complete once
						you’ve returned the gear.
					</p>
				</div>
				<div className={styles.warning_container}>
					...
					<p className={styles.warning}>
						{isTimeElapsed
							? `You have an overdue payment request from the lender for the extended usage of the gear. To ensure a seamless experience, please review and address the pending payment request promptly.
`
			...
			<PaymentRequest
				...
				setOpenPaymentRequest={setOpenPaymentRequest}
				setShowPaymentForm={setOpenPaymentForm}
			/>
			<PaymentForm
				showPaymentForm={openPaymentForm}
				setShowPaymentForm={setOpenPaymentForm}
