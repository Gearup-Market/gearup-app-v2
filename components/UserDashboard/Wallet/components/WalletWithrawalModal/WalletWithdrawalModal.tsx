...
const WalletWithrawalModal = ({
	...
	const isBankDetails = user.bankName && user.accountNumber;

	const handleSubmit = () => {
		if (!isBankDetails) {
			router.push("/user/settings?q=payments");
		} else {
